...
// console.log('por Postman trae', respuesta_api.length, 'objetos')
// console.log('Por chome trae', res_web.length, 'objetos')
// console.log('Con slice(0,8) trae', respuesta_slice.length, 'objetos')

//console.log('Por postman trae', respuesta_api[171])
//console.log('Por chome trae', res_web[171])
//console.log(Object.keys(respuesta_api[0]))

// const respuestaDb = [ dog {
//     dataValues: {
//       id: '37da0ead-5d9d-4852-8f9f-7f1b9c1935df',
//       name: 'prince',
//       height: 'alto',
//       weight: '25 kls',
//       years_life: '13 - 15',
//       image: null,
//       createdAt: 2021-07-07T20:04:58.844Z,
//       updatedAt: 2021-07-07T20:04:58.844Z
//     },
//     _previousDataValues: {
//       id: '37da0ead-5d9d-4852-8f9f-7f1b9c1935df',
//       name: 'prince',
...
const obtener = (name) =>{
    const dogs = []
     i =0
    while(dogs.length <=8 && i < respuesta_api.length){
        if(respuesta_api[i].name.includes(name)) {
            dogs.push(respuesta_api[i])
        }
        i++
...
// llena la db con los datos de la api
async function createDogsss(){
    const dogApi = respuesta_api
...
//   const categories = [{"id":1,"name":"Stubborn"},{"id":2,"name":" Curious"},{"id":3,"name":" Playful"},{"id":4,"name":" Adventurous"},{"id":5,"name":" Active"},{"id":6,"name":" Fun-loving"},{"id":7,"name":"Aloof"},{"id":8,"name":" Clownish"},{"id":9,"name":" Dignified"},{"id":10,"name":" Independent"},{"id":11,"name":" Happy"},{"id":12,"name":"Wild"},{"id":13,"name":" Hardworking"},{"id":14,"name":" Dutiful"},{"id":15,"name":"Outgoing"},{"id":16,"name":" Friendly"},{"id":17,"name":" Alert"},{"id":18,"name":" Confident"},{"id":19,"name":" Intelligent"},{"id":20,"name":" Courageous"},{"id":21,"name":"Loyal"},{"id":22,"name":" Brave"},{"id":23,"name":"Docile"},{"id":24,"name":" Responsive"},{"id":25,"name":" Composed"},{"id":26,"name":" Receptive"},{"id":27,"name":" Faithful"},{"id":28,"name":"Loving"},{"id":29,"name":" Protective"},{"id":30,"name":" Trainable"},{"id":31,"name":" Responsible"},{"id":32,"name":"Friendly"},{"id":33,"name":" Energetic"},{"id":34,"name":" Loyal"},{"id":35,"name":" Gentle"},{"id":36,"name":" Affectionate"},{"id":37,"name":" Devoted"},{"id":38,"name":" Assertive"},{"id":39,"name":" Dominant"},{"id":40,"name":"Strong Willed"},{"id":41,"name":" Stubborn"},{"id":42,"name":" Obedient"},{"id":43,"name":" Reserved"},{"id":44,"name":"Kind"},{"id":45,"name":" Sweet-Tempered"},{"id":46,"name":" Loving"},{"id":47,"name":"Tenacious"},{"id":48,"name":" Attentive"},{"id":49,"name":"Steady"},{"id":50,"name":" Bold"},{"id":51,"name":" Proud"},{"id":52,"name":"Reliable"},{"id":53,"name":" Fearless"},{"id":54,"name":" Lively"},{"id":55,"name":" Self-assured"},{"id":56,"name":"Cautious"},{"id":57,"name":" Eager"},{"id":58,"name":"Good-natured"},{"id":59,"name":"Spirited"},{"id":60,"name":" Companionable"},{"id":61,"name":" Even Tempered"},{"id":62,"name":" Rugged"},{"id":63,"name":" Fierce"},{"id":64,"name":" Refined"},{"id":65,"name":"Obedient"},{"id":66,"name":" Joyful"},{"id":67,"name":"Affectionate"},{"id":68,"name":" Agile"},{"id":69,"name":"Amiable"},{"id":70,"name":" Excitable"},{"id":71,"name":" Determined"},{"id":72,"name":"Self-confidence"},{"id":73,"name":" Hardy"},{"id":74,"name":"Fearless"},{"id":75,"name":" Calm"},{"id":76,"name":" Spirited"},{"id":77,"name":" Good-tempered"},{"id":78,"name":"Watchful"},{"id":79,"name":" Hard-working"},{"id":80,"name":"Energetic"},{"id":81,"name":"Feisty"},{"id":82,"name":" Cheerful"},{"id":83,"name":" Sensitive"},{"id":84,"name":"Easygoing"},{"id":85,"name":" Adaptable"},{"id":86,"name":" Trusting"},{"id":87,"name":" Lovable"},{"id":88,"name":" Territorial"},{"id":89,"name":" Keen"},{"id":90,"name":"Protective"},{"id":91,"name":" Familial"},{"id":92,"name":" Rational"},{"id":93,"name":"Devoted"},{"id":94,"name":" Bright"},{"id":95,"name":"Agile"},{"id":96,"name":" Quick"},{"id":97,"name":"Trainable"},{"id":98,"name":" Reliable"},{"id":99,"name":" Powerful"},{"id":100,"name":"Hardy"},{"id":101,"name":" Gay"},{"id":102,"name":" Stable"},{"id":103,"name":" Quiet"},{"id":104,"name":" Inquisitive"},{"id":105,"name":"Alert"},{"id":106,"name":" Strong"},{"id":107,"name":" Sociable"},{"id":108,"name":" Patient"},{"id":109,"name":"Suspicious"},{"id":110,"name":" Great-hearted"},{"id":111,"name":" Merry"},{"id":112,"name":" Vocal"},{"id":113,"name":" Tolerant"},{"id":114,"name":" Mischievous"},{"id":115,"name":" People-Oriented"},{"id":116,"name":" Bossy"},{"id":117,"name":" Cunning"},{"id":118,"name":" Watchful"},{"id":119,"name":" Cautious"},{"id":120,"name":"Playful"},{"id":121,"name":" Easygoing"},{"id":122,"name":" Athletic"},{"id":123,"name":"Boisterous"},{"id":124,"name":" Cooperative"},{"id":125,"name":" Kind"},{"id":126,"name":"Intelligent"},{"id":127,"name":" Trustworthy"},{"id":128,"name":"Self-important"},{"id":129,"name":"Respectful"},{"id":130,"name":"Sweet-Tempered"},{"id":131,"name":" Thoughtful"},{"id":132,"name":" Generous"},{"id":133,"name":"Mischievous"},{"id":134,"name":" Cat-like"},{"id":135,"name":" Sturdy"},{"id":136,"name":"Benevolent"},{"id":137,"name":"Clownish"},{"id":138,"name":" Outgoing"},{"id":139,"name":"Keen"},{"id":140,"name":"Clever"},{"id":141,"name":" Docile"},{"id":142,"name":"Sociable"},{"id":143,"name":" Bubbly"},{"id":144,"name":"Opinionated"},{"id":145,"name":" Good-natured"},{"id":146,"name":" Aggressive"},{"id":147,"name":" Suspicious"},{"id":148,"name":"Bold"},{"id":149,"name":"Extroverted"},{"id":150,"name":" Clever"},{"id":151,"name":" Charming"},{"id":152,"name":"Lively"},{"id":153,"name":" Unflappable"},{"id":154,"name":"Charming"},{"id":155,"name":" Spunky"},{"id":156,"name":" Diligent"},{"id":157,"name":" Tenacious"},{"id":158,"name":" Aloof"},{"id":159,"name":"Willful"},{"id":160,"name":" Amiable"},{"id":161,"name":" Fast"},{"id":162,"name":" Vigilant"},{"id":163,"name":"Cheerful"}];
//   let names_categories = categories.map(c => c.name).map( c => c.trim())
//   console.log(names_categories,'son: ',names_categories.length)
//   names_categories = names_categories.map( c => c.trim())
//   console.log(names_categories,'son: ',names_categories.length)

const total_categories = respuesta_api.filter( c => c?.temperament?.length >1)
console.log('La api trae: ',total_categories.length,'perros con categorias')
 // let temperaments = dogApi[i].temperament?.split(',').map( c => c.trim())
